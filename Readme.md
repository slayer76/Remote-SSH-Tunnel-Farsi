...
<p>برای دوستانی که vless tcp را برای همراه اول لازم میدانند، پروتکل trojan پیشنهاد میشود، خصوصا با ترانسپورت ws ساخته شود، اگر مشکل ارتباط با این پروتکل دارند، لازم هست که انتهای لینک قبل از کرکتر # که نام کانفیگ را مشخص میکند این تیکه هر کلاینت، متن زیر را اضافه کنند</p>
