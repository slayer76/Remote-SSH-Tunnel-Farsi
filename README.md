...
**توجه داشته باشید که تمام فرمان ها باید با یوزر root اجرا شوند، اگر دسترسی روت ندارید میتونید با اجرای فرمان زیر به یوزر روت سوییچ کنید: **
<code>sudo su root</code>

سپس به اجرای فرمان ها بپردازید.
