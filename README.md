...
<p>برای دوستانی که vless tcp را برای همراه اول لازم میدانند، پروتکل trojan پیشنهاد میشود، خصوصا با ترانسپورت ws ساخته شود، اگر مشکل ارتباط با این پروتکل دارند، از تنظیمات کلاینت گزینه allowInsecure را فعال کنند.</p>
